...
# plot_pcoa.R
#
# Here we take in the *.pcoa.axes file from the mouse stability analysis and
# plot it in R as we did in Figure 4 of Kozich et al.
#
# Dependencies:   2-D axes file generated by the pcoa command in mothur
# Produces:       results/figures/pcoa_figure.png
#
################################################################################
plot_pcoa <- function(axes_file){
